...
<template>
  <section
    class="flex flex-col items-center w-full p-[16px] rounded-lg bg-white space-y-[16px] text-white text-[14px]"
  >
    <CountDown
    ...
    />
    <div class="w-full flex flex-col max-w-[500px] space-y-[16px]">
      <AvailableTickets
